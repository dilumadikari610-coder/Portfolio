...
export default function Contact({ personalInfo, style }) {
  return (
    <section id="contact" className="py-24 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-zinc-900 relative bg-transparent">
      <div className="relative z-10 flex flex-col items-center text-center space-y-10">
        ...
        <ScrollReveal direction="up" delay={150}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-3xl font-sans text-left">
            <div className="flex items-start gap-4 p-5 rounded-2xl bg-zinc-900/80 border border-zinc-800 shadow-lg hover:shadow-black/40 transition-shadow duration-300 backdrop-blur-sm">
              <div className="p-3 bg-zinc-950/50 rounded-xl text-zinc-300 border border-zinc-800 shrink-0"><Mail className="w-5 h-5" /></div>
              <div>
            ...
            <div className="flex items-start gap-4 p-5 rounded-2xl bg-zinc-900/80 border border-zinc-800 shadow-lg hover:shadow-black/40 transition-shadow duration-300 backdrop-blur-sm">
              <div className="p-3 bg-zinc-950/50 rounded-xl text-zinc-300 border border-zinc-800 shrink-0"><Phone className="w-5 h-5" /></div>
              <div>
            ...
            <div className="flex items-start gap-4 p-5 rounded-2xl bg-zinc-900/80 border border-zinc-800 shadow-lg hover:shadow-black/40 transition-shadow duration-300 sm:col-span-2 backdrop-blur-sm">
              <div className="p-3 bg-zinc-950/50 rounded-xl text-zinc-300 border border-zinc-800 shrink-0"><MapPin className="w-5 h-5" /></div>
              <div>
