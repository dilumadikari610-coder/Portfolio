        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {skillItems.map((item, idx) => (
            <ScrollReveal key={idx} direction="scale" delay={idx * 50}>
              <div className="p-6 rounded-2xl bg-zinc-900 border border-zinc-800/80 space-y-4 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 h-full flex flex-col justify-between">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="p-3 bg-zinc-950 rounded-xl text-zinc-300 border border-zinc-800">
