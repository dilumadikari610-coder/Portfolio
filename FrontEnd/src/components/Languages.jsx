...
export default function Languages({ personalInfo, style, selectedLanguageIndex, setSelectedLanguageIndex }) {
  return (
    <section id="languages" className="py-24 border-t border-zinc-900 bg-transparent relative z-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-5 space-y-6">
            <ScrollReveal direction="left">
              <div className="space-y-4 text-left">
                ...
                <div className="p-4 rounded-xl bg-zinc-900/80 border border-zinc-800 backdrop-blur-sm space-y-2">
                  <p className="text-xs text-zinc-500 font-medium">
                   <strong>Did you know?</strong> Moratuwa BIT programs are taught in English, enabling Adikari to conduct deep structural operations.
                  </p>
                </div>
              </div>
            </ScrollReveal>
          ...
          <div className="lg:col-span-7">
            <ScrollReveal direction="right">
              <div className="p-6 sm:p-8 rounded-3xl bg-zinc-900/80 border border-zinc-800 shadow-2xl shadow-black/80 grid grid-cols-1 md:grid-cols-12 gap-8 items-center backdrop-blur-sm">
                    ...
                    return (
                      <div 
                        ...
                        className={`flex flex-col items-center p-4 rounded-2xl cursor-pointer transition-all duration-300 ${
                          isSelected ? 'bg-zinc-950/90 border border-zinc-800 scale-105 shadow-md' : 'hover:bg-zinc-950/30 border border-transparent hover:scale-102'
                        }`}
                      >
