...
// Import your image asset path here
import ProfileImg from '../assets/prifile 2.jpg'; 

export default function Hero({ personalInfo, style, scrollY, scrollTo }) {
  // Safe icon lookups for fallback states
  ...
  return (
    <section 
      id="home" 
      className="relative min-h-screen w-full flex items-center justify-center bg-zinc-950 overflow-hidden pt-16 md:pt-20"
    >
      ...
      {/* Split Background Content Panel Grid (Removed border line) */}
      <div className="absolute inset-0 grid grid-cols-1 lg:grid-cols-12 w-full h-full pointer-events-none">
        <div className="lg:col-span-7 bg-zinc-900/60 w-full h-full" />
        <div className="lg:col-span-5 bg-zinc-950 w-full h-full" />
      </div>
        ...
        <div className="lg:col-span-7 flex flex-col justify-center text-left space-y-6 lg:pr-12">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            ...
            <a 
              ...
              className="px-8 py-3.5 rounded-xl font-bold transition-all text-xs uppercase tracking-widest border border-zinc-800 hover:border-zinc-700 bg-zinc-900/40 hover:bg-zinc-900 text-zinc-200 hover:text-white text-center transition-colors"
            >
              Connect On LinkedIn
            </a>
          </div>
