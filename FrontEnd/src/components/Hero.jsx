  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 grid grid-cols-1 lg:grid-cols-12 w-full h-full pointer-events-none">
        <div className="lg:col-span-7 bg-zinc-900/20 w-full h-full" /> {/* Changed bg-zinc-900/60 to /20 */}
        <div className="lg:col-span-5 bg-transparent w-full h-full" /> {/* Changed bg-zinc-950 to bg-transparent */}
      </div>
