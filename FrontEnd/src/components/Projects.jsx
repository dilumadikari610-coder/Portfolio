...
export default function Projects({ projects, style, handleRemoveProject }) {
  ...
  return (
    <section id="projects" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 bg-zinc-950">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((proj, idx) => (
          <ScrollReveal 
            ...
            delay={idx * 150}
          >
            <div className="group bg-zinc-900 border border-zinc-800/80 rounded-2xl overflow-hidden hover:shadow-xl hover:shadow-black/40 transition-all duration-300 flex flex-col h-full relative">
